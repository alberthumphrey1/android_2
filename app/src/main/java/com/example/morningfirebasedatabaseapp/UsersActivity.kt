    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reference.addValueEventListener(object:ValueEventListener{
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(applicationContext, "Please contact the admin", Toast.LENGTH_SHORT).show()
            }
        })
        ...
        listUsers!!.setOnItemClickListener { adapterView, view, i, l ->
            ...
            val deletetionReference = FirebaseDatabase.getInstance().getReference().child("Users/$userId")
